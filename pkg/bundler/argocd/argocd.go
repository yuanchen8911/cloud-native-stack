...
func (g *Generator) Generate(ctx context.Context, input *GeneratorInput, outputDir string) (*GeneratorOutput, error) {
	...
	readmeData := ReadmeData{
		...
		OutputDir:      filepath.Base(outputDir),
	}
...
func (g *Generator) generateFromTemplate(tmplContent string, data interface{}, outputPath string) (int64, error) {
...
func (g *Generator) writeValuesFile(values map[string]interface{}, outputPath string) (int64, error) {
	var buf strings.Builder
